...
**Discount → Total.Spent (-0.98):**
A primeira correlação observada foi entre o desconto e o total gasto. Trata-se de uma correlação negativa muito forte, indicando que, à medida que o total gasto aumenta, o desconto tende a diminuir. De forma inversa, quando o total gasto diminui, o desconto tende a aumentar.

**Revenue → Total.Spent (0.88):**
A segunda correlação observada foi entre a receita e o total gasto. Trata-se de uma correlação positiva forte, indicando que, à medida que o total gasto aumenta, a receita também tende a aumentar. Da mesma forma, quando o total gasto diminui, a receita tende a diminuir.

**Items Purchased → Total.Spent (0.84):**
